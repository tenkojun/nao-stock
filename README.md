...
60대 장기투자자를 위한 한국주식 분석 데스크톱 프로그램
...
아버지는 매달 남는 돈으로 주식을 사십니다. 한 달에 열 번쯤 사고, 한두 번 파십니다.
떨어지면 더 사서 평단을 낮추는 습관이 있고, 1개월에서 1년쯤 들고 계십니다.

그런 분께 필요한 건 "오를까요 내릴까요"에 대한 대답이 아니었습니다.
**지금 내 계좌가 한쪽으로 쏠려 있지는 않은지, 이번 달 여윳돈을 어떻게 나눌지,
세금과 수수료를 빼면 실제로 얼마가 남는지** — 확실하게 계산할 수 있는 것들이었습니다.
